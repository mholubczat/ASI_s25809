...
# asi_loanpredictor documentation build
...
from asi_loanpredictor import __version__ as release

# -- Project information -----------------------------------------------------

project = "asi_loanpredictor"
author = "Kedro"
...
htmlhelp_basename = "asi_loanpredictordoc"
...
latex_documents = [
    (
        master_doc,
        "asi_loanpredictor.tex",
        "asi_loanpredictor Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "asi_loanpredictor",
        "Project asi_loanpredictor codebase.",
        "Data-Science",
    )
]
